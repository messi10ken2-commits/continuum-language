...
export const lessonList=[
 ...
 q('What is the new gate?',['B12.','B16.','A16.'],1,'La nueva puerta es la B dieciséis.',{audio:'Atención, pasajeros. El vuelo a Madrid ya no sale por la puerta B doce. La nueva puerta es la B dieciséis.',audioSpeech:'Atención, pasajeros. El vuelo a Madrid ya no sale por la puerta be doce. La nueva puerta es la be dieciséis.'}),
